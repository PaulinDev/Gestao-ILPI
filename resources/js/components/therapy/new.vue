    ...
    <div>
        <v-card class="px-5 py-3">
            ...
            <v-form class="mt-5" ref="formValidate" lazy-validation v-model="formValidate">
                ...
                <v-card-title>
                    <span class="text-h5">Registrar Terapêutica</span>
                </v-card-title>
                ...
                <v-card-actions>
                    ...
                    <v-btn
                        color="error"
                        text
                        @click="$emit('listenNewTherapy',true);"
                    >
                        Cancelar
                    </v-btn>
                    <v-btn
...
export default {
    ...
    methods: {
        ...
        requestNewTherapy(){
            ...
            axios.post(this.urlBaseApiTherapy, data, settings)
                .then(response => {
                    this.$emit('listenNewTherapy');
                }).catch(error => {
                console.log(error);
                this.alert = true;
